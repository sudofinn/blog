  ...
  return (
    <div>
        <div className='flex flex-col '>
            ...
            <p  data-aos="fade-up" className="text-black text-2xl text-center mb-12 mt-8 mx-16 sm:mx-48 leading-[50px]">I generally love   having something on the internet where
