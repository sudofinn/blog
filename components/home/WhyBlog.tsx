  ...
  return (
    <div>
        <div className='flex flex-col '>
            <h1  data-aos="fade-up" className="text-5xl  hover:scale-110 duration-500 text-center mt-32">Why creating a blog?</h1>
            <p  data-aos="fade-up" className="text-black  text-2xl text-center mb-12 mt-8 mx-16 sm:mx-48 leading-[60px]">I generally love   having something on the internet where
